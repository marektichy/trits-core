...
class TritsGame {
    ...
    restoreSaved(data) {
        ...
        /*this.bets.F = Object.keys(data.bets.F).map(function (key) { return data.bets.F[key]; });
        this.bets.S = Object.keys(data.bets.S).map(function (key) { return data.bets.S[key]; });
        this.bets.G = Object.keys(data.bets.G).map(function (key) { return data.bets.G[key]; });
        */
    }
